...
販路やイベントにより販売時の内容は異なります。足りないものをそれぞれ揃えてください。
 - 基板  
   1枚  
   「Engineering Dept. × Veritas RE Aoharu AL-1S Style Keyboard」と、バージョン情報が書き込まれた面が表側となります。  
    ほぼすべての作業を**裏面**に行います。  
    ビルドガイド内で左右を指定している場合、傾斜が向いている方向が手前となります。
 - スイッチプレート  
   1枚  
 ...
 - ダイオード  
   88個 1N4148シリーズ 表面実装、リードどちらを使用しても構いません。
 - MX用 2Uスタビライザー  
   3個　PCBマウントタイプ
...
単品購入が必要だったり、移植する必要がある可能性の高いキーは以下の通りです。
 - 右Shift
   1.25U @R2が必要です。ISO Left Shiftとして使われているものなので、入手性は低くないと思います。  
 - Space  
...
[具体的なキー幅はKLEでも確認できます。](https://www.keyboard-layout-editor.com/##@@_x:0.5%3B&=0,0&_x:0.25%3B&=0,1&_x:0.75%3B&=0,3&=0,4&=0,5&=0,6&_x:0.75%3B&=0,7&=6,0&=6,1&=6,2&_x:0.5%3B&=6,3&=6,4&=6,5&=6,6&_x:0.25%3B&=6,7&_x:0.5%3B&=0,0%0A%0A%0A%0A%0A%0A%0A%0A%0Ae&=0,1%0A%0A%0A%0A%0A%0A%0A%0A%0Ae%3B&@_y:0.25&x:0.5%3B&=1,0&=1,1&=1,2&=1,3&=1,4&=1,5&=1,6&_x:0.75%3B&=1,7&=7,0&=7,1&=7,2&_x:0.5%3B&=7,3&=7,4&=7,5&=7,6&_x:0.25%3B&=7,7%3B&@_x:0.25&w:1.5%3B&=2,0&=2,1&=2,2&=2,3&=2,4&=2,5&_x:1.5%3B&=2,7&=8,0&=8,1&=8,2&=8,3&=8,4&=8,5&_x:0.25&w:1.25&h:2&w2:1.5&h2:1&x2:-0.25%3B&=8,6&_x:0.5%3B&=8,7%3B&@_w:1.75%3B&=3,0&=3,1&=3,2&=3,3&=3,4&=3,5&_x:1.75%3B&=3,7&=9,0&=9,1&=9,2&=9,3&=9,4&=9,5&_x:2%3B&=9,7%3B&@_w:2%3B&=4,0&=4,1&=4,2&=4,3&=4,4&=4,5&_x:1%3B&=4,7&=10,0&=10,1&=10,2&=10,3&=10,4&=10,5&_w:1.25%3B&=10,6&_x:0.25%3B&=10,7%3B&@_w:1.5%3B&=5,0&=5,1&_w:1.25%3B&=5,2&=5,3&_w:2.25%3B&=5,4&_x:1&w:1.75%3B&=5,7&_w:1.25%3B&=11,1&_w:1.25%3B&=11,2&_w:1.25%3B&=11,3&_w:1.25%3B&=11,4&_x:0.75%3B&=11,5&=11,6&=11,7)
...
<details><summary>別のキーが反応する・勝手に反応する</summary>はんだの短絡を疑います。多すぎる場所から回収してください。</details>
<details><summary>それ以外の問題</summary>製作者に連絡してください。</details>
...
### 組み付け
まずバックパネルの表から7mmのネジを通し、上に硬い板を乗せる、マスキングテープで留めるなどして脱落を防止し、ひっくり返します。  
上向いたネジに2mmのスペーサーを通し、更に基板を重ねます。  
...
# カスタムガイド
## おすすめキースイッチ
スイッチプレート、基板、バックパネルを固定する構造のため、サンドイッチマウントとしては剛性がかなり高くなっています。  
